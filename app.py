...
def predict():
    try:
        ...
        # Autoencoder anomaly score — normalized MSE
        # MSE_MAX is the ~99th percentile of MSE seen during training.
        # Normal transactions produce MSE ~0.01-0.05; anomalies go higher.
        ...
        # Hybrid Score: 70% XGBoost + 30% Autoencoder (matches training notebook)
