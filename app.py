...
decoder      = keras.layers.Dense(15, activation='linear')(encoder)
...
def predict():
    try:
        ...
        # For single predictions, treat raw mse as normalized (clipped to 0-1)
        mse_norm = float(np.clip(mse, 0, 1))
